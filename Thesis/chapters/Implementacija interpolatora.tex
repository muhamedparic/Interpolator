...
\includegraphics[scale=0.2]{Frame1}
\centering
\end{figure}

\begin{figure}[H]
\caption {Interpolirani frejm}
\includegraphics[scale=0.2]{Frame2}
\centering
\end{figure}

\begin{figure}[H]
\caption{Naredni frejm}
\includegraphics[scale=0.2]{Frame3}
\centering
\end{figure}
...
\begin{figure}[H]
\caption{Prethodni frejm}
\includegraphics[scale=0.2]{Frame9}
\centering
\end{figure}

\begin{figure}[H]
\caption{Interpolirani frejm}
\includegraphics[scale=0.2]{Frame10}
\centering
\end{figure}

\begin{figure}[H]
\caption{Naredni frejm}
\includegraphics[scale=0.2]{Frame11}
\centering
\end{figure}
...
\includegraphics[scale=0.2]{Frame4}
\centering
\end{figure}